...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Alumni Connect</a>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">You are the one soul that's been enlightened!!</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="text-white mt-0">Alumni Association!</h2>
          <hr class="divider light my-4">
          <p class="text-white-50 mb-4">
            Greetings from Your Institution !!</p>
            <p class="text-white-50 mb-4">College Management</p>
          <a class="btn btn-light btn-xl js-scroll-trigger" href="user/userlogin.php">Stay Connected!</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="page-section" id="services">
    <div class="container">
      <h2 class="text-center mt-0">Why Alumni Association?</h2>
      <hr class="divider my-4">
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-user-friends text-primary mb-4"></i>
            <h3 class="h4 mb-2">Friendship</h3>
            <p class="text-muted mb-0">The True bond, You'll stay connected with your friends no matter how far you are!!</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <p class="text-muted mb-0">You'll be updated with any events/news related to alumni.</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-gem text-primary mb-4"></i>
            <h3 class="h4 mb-2">Opportunities</h3>
            <p class="text-muted mb-0">As a part of the association you will be able to find many opportunities within!</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-globe text-primary mb-4"></i>
            <h3 class="h4 mb-2">Spread Knowledge</h3>
            <p class="text-muted mb-0">Not only check the events/news, you can conduct/organize events which benefits everyone!</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <hr class="divider my-4">
          <p class="text-muted mb-5">Any help or assistance ?  Give us a call or send us an email and we will get back to you as soon as possible!</p>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto text-center">
          ...
          <a class="d-block" href="mailto:institue@edu.in">mail@edu.in</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright @2019 by Arun & Gnanendra</div>
    </div>
  </footer>
